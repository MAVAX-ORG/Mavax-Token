...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1 * (10 ** 17); // 0.1 AVAX minimum auto send
    uint256 public minimumTokenBalanceForDividends = 20000 * (10**9); // user must hold 20000 token
...
contract MAVAX is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Mini Avalanche";
